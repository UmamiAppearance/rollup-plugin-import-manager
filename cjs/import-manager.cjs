...
var ImportManager = require('import-manager');
var diff = require('diff');
var colorette = require('colorette');

function _interopDefaultLegacy (e) { return e && typeof e === 'object' && 'default' in e ? e : { 'default': e }; }

var ImportManager__default = /*#__PURE__*/_interopDefaultLegacy(ImportManager);
...
const importManager = (options={}) => {
    ...
    return {
        ...
        transform (source, id) {
            ...
            const manager = new ImportManager__default["default"](source, id, warnSpamProtection, warnings);       
